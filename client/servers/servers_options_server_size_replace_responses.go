...
func (o *ServersOptionsServerSizeReplaceOK) GetPayload() interface{} {
	return o.Payload
}
...
func (o *ServersOptionsServerSizeReplaceBadRequest) GetPayload() interface{} {
	return o.Payload
}
...
func (o *ServersOptionsServerSizeReplaceNotFound) GetPayload() interface{} {
	return o.Payload
}
