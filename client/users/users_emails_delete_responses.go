...
func (o *UsersEmailsDeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /users/emails/{id}/][%d] usersEmailsDeleteNoContent ", 204)
}
...
func (o *UsersEmailsDeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /users/emails/{id}/][%d] usersEmailsDeleteNotFound  %+v", 404, o.Payload)
}
