...
func (o *UsersEmailsUpdateParams) WithData(data *models.EmailData) *UsersEmailsUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the users emails update params
func (o *UsersEmailsUpdateParams) SetData(data *models.EmailData) {
	o.Data = data
}
...
// WithUserID adds the userID to the users emails update params
func (o *UsersEmailsUpdateParams) WithUserID(userID string) *UsersEmailsUpdateParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the users emails update params
func (o *UsersEmailsUpdateParams) SetUserID(userID string) {
	o.UserID = userID
}
