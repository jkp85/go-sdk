...
func (o *UserAvatarUpdateOK) GetPayload() interface{} {
	return o.Payload
}
...
func (o *UserAvatarUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}
...
func (o *UserAvatarUpdateNotFound) GetPayload() interface{} {
	return o.Payload
}
