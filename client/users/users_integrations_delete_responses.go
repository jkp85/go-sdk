...
func (o *UsersIntegrationsDeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /users/integrations/{id}/][%d] usersIntegrationsDeleteNoContent ", 204)
}
...
func (o *UsersIntegrationsDeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /users/integrations/{id}/][%d] usersIntegrationsDeleteNotFound  %+v", 404, o.Payload)
}
