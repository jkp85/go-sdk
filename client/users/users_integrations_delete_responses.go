...
func (o *UsersIntegrationsDeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /v1/users/{user_id}/integrations/{id}/][%d] usersIntegrationsDeleteNoContent ", 204)
}
...
func (o *UsersIntegrationsDeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /v1/users/{user_id}/integrations/{id}/][%d] usersIntegrationsDeleteNotFound  %+v", 404, o.Payload)
}
