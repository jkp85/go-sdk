...
// WithUserID adds the userID to the users api key reset params
func (o *UsersAPIKeyResetParams) WithUserID(userID string) *UsersAPIKeyResetParams {
	o.SetUserID(userID)
	return o
}

// SetUserID adds the userId to the users api key reset params
func (o *UsersAPIKeyResetParams) SetUserID(userID string) {
	o.UserID = userID
}
