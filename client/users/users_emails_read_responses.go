...
func (o *UsersEmailsReadOK) Error() string {
	return fmt.Sprintf("[GET /users/emails/{id}/][%d] usersEmailsReadOK  %+v", 200, o.Payload)
}
...
func (o *UsersEmailsReadNotFound) Error() string {
	return fmt.Sprintf("[GET /users/emails/{id}/][%d] usersEmailsReadNotFound  %+v", 404, o.Payload)
}
