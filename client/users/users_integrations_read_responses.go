...
func (o *UsersIntegrationsReadOK) Error() string {
	return fmt.Sprintf("[GET /v1/users/{user_id}/integrations/{id}/][%d] usersIntegrationsReadOK  %+v", 200, o.Payload)
}
...
func (o *UsersIntegrationsReadNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/users/{user_id}/integrations/{id}/][%d] usersIntegrationsReadNotFound  %+v", 404, o.Payload)
}
