...
func (o *UsersIntegrationsUpdateOK) Error() string {
	return fmt.Sprintf("[PUT /users/integrations/{id}/][%d] usersIntegrationsUpdateOK  %+v", 200, o.Payload)
}
...
func (o *UsersIntegrationsUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /users/integrations/{id}/][%d] usersIntegrationsUpdateBadRequest  %+v", 400, o.Payload)
}
