...
func (o *BillingCardsCreateParams) WithData(data BillingCardsCreateBody) *BillingCardsCreateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the billing cards create params
func (o *BillingCardsCreateParams) SetData(data BillingCardsCreateBody) {
	o.Data = data
}
