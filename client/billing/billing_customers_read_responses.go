...
func (o *BillingCustomersReadOK) Error() string {
	return fmt.Sprintf("[GET /{namespace}/billing/customers/{id}/][%d] billingCustomersReadOK  %+v", 200, o.Payload)
}
...
func (o *BillingCustomersReadNotFound) Error() string {
	return fmt.Sprintf("[GET /{namespace}/billing/customers/{id}/][%d] billingCustomersReadNotFound  %+v", 404, o.Payload)
}
