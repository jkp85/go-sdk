...
func (o *BillingPlansReadOK) Error() string {
	return fmt.Sprintf("[GET /{namespace}/billing/plans/{id}/][%d] billingPlansReadOK  %+v", 200, o.Payload)
}
...
func (o *BillingPlansReadNotFound) Error() string {
	return fmt.Sprintf("[GET /{namespace}/billing/plans/{id}/][%d] billingPlansReadNotFound  %+v", 404, o.Payload)
}
