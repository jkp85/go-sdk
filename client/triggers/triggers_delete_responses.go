...
func (o *TriggersDeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /{namespace}/triggers/{id}/][%d] triggersDeleteNoContent ", 204)
}
...
func (o *TriggersDeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /{namespace}/triggers/{id}/][%d] triggersDeleteNotFound  %+v", 404, o.Payload)
}
