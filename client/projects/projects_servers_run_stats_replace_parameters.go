...
// WithData adds the data to the projects servers run stats replace params
func (o *ProjectsServersRunStatsReplaceParams) WithData(data *models.ServerRunStatisticsData) *ProjectsServersRunStatsReplaceParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the projects servers run stats replace params
func (o *ProjectsServersRunStatsReplaceParams) SetData(data *models.ServerRunStatisticsData) {
	o.Data = data
}
