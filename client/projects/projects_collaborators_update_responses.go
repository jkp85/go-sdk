...
func (o *ProjectsCollaboratorsUpdateBadRequestBody) validateMember(formats strfmt.Registry) error {

	if err := validate.Required("projectsCollaboratorsUpdateBadRequest"+"."+"member", "body", o.Member); err != nil {
		return err
	}
