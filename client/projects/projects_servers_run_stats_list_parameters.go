...
// WithOrdering adds the ordering to the projects servers run stats list params
func (o *ProjectsServersRunStatsListParams) WithOrdering(ordering *string) *ProjectsServersRunStatsListParams {
	o.SetOrdering(ordering)
	return o
}

// SetOrdering adds the ordering to the projects servers run stats list params
func (o *ProjectsServersRunStatsListParams) SetOrdering(ordering *string) {
	o.Ordering = ordering
}

// WithProjectID adds the projectID to the projects servers run stats list params
func (o *ProjectsServersRunStatsListParams) WithProjectID(projectID string) *ProjectsServersRunStatsListParams {
	o.SetProjectID(projectID)
	return o
}

// SetProjectID adds the projectId to the projects servers run stats list params
func (o *ProjectsServersRunStatsListParams) SetProjectID(projectID string) {
	o.ProjectID = projectID
}

// WithServerID adds the serverID to the projects servers run stats list params
func (o *ProjectsServersRunStatsListParams) WithServerID(serverID string) *ProjectsServersRunStatsListParams {
	o.SetServerID(serverID)
	return o
}

// SetServerID adds the serverId to the projects servers run stats list params
func (o *ProjectsServersRunStatsListParams) SetServerID(serverID string) {
	o.ServerID = serverID
}
