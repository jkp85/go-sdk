...
func (o *ProjectsCollaboratorsReadOK) Error() string {
	return fmt.Sprintf("[GET /v1/{namespace}/projects/{project_id}/collaborators/{id}/][%d] projectsCollaboratorsReadOK  %+v", 200, o.Payload)
}
...
func (o *ProjectsCollaboratorsReadNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/{namespace}/projects/{project_id}/collaborators/{id}/][%d] projectsCollaboratorsReadNotFound  %+v", 404, o.Payload)
}
