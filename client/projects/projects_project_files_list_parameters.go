...
// WithProjectPk adds the projectPk to the projects project files list params
func (o *ProjectsProjectFilesListParams) WithProjectPk(projectPk string) *ProjectsProjectFilesListParams {
	o.SetProjectPk(projectPk)
	return o
}

// SetProjectPk adds the projectPk to the projects project files list params
func (o *ProjectsProjectFilesListParams) SetProjectPk(projectPk string) {
