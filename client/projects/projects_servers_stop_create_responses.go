...
func (o *ProjectsServersStopCreateCreated) Error() string {
	return fmt.Sprintf("[POST /{namespace}/projects/{project_pk}/servers/{id}/stop/][%d] projectsServersStopCreateCreated ", 201)
}
...
func (o *ProjectsServersStopCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /{namespace}/projects/{project_pk}/servers/{id}/stop/][%d] projectsServersStopCreateBadRequest ", 400)
}
