...
func (o *ProjectsServersStatsUpdateOK) GetPayload() interface{} {
	return o.Payload
}
...
func (o *ProjectsServersStatsUpdateBadRequest) GetPayload() interface{} {
	return o.Payload
}
...
func (o *ProjectsServersStatsUpdateNotFound) GetPayload() interface{} {
	return o.Payload
}
