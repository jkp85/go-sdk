...
func (o *ProjectsServersCreateCreated) Error() string {
	return fmt.Sprintf("[POST /v1/{namespace}/projects/{project_id}/servers/][%d] projectsServersCreateCreated  %+v", 201, o.Payload)
}
...
func (o *ProjectsServersCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /v1/{namespace}/projects/{project_id}/servers/][%d] projectsServersCreateBadRequest  %+v", 400, o.Payload)
}
