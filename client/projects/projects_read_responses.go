...
func (o *ProjectsReadOK) Error() string {
	return fmt.Sprintf("[GET /v1/{namespace}/projects/{id}/][%d] projectsReadOK  %+v", 200, o.Payload)
}
...
func (o *ProjectsReadNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/{namespace}/projects/{id}/][%d] projectsReadNotFound  %+v", 404, o.Payload)
}
