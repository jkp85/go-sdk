...
func (o *ProjectsReadOK) GetPayload() interface{} {
	return o.Payload
}

func (o *ProjectsReadOK) Error() string {
	return fmt.Sprintf("[GET /v1/{namespace}/projects/{project}/][%d] projectsReadOK  %+v", 200, o.Payload)
}
...
func (o *ProjectsReadNotFound) GetPayload() interface{} {
	return o.Payload
}

func (o *ProjectsReadNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/{namespace}/projects/{project}/][%d] projectsReadNotFound  %+v", 404, o.Payload)
}
