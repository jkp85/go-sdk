...
func (o *ProjectsDeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /v1/{namespace}/projects/{id}/][%d] projectsDeleteNoContent ", 204)
}
...
func (o *ProjectsDeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /v1/{namespace}/projects/{id}/][%d] projectsDeleteNotFound  %+v", 404, o.Payload)
}
