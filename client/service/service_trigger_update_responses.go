...
func (o *ServiceTriggerUpdateOK) Error() string {
	return fmt.Sprintf("[PATCH /v1/{namespace}/service/{server_id}/trigger/{id}/][%d] serviceTriggerUpdateOK  %+v", 200, o.Payload)
}
...
func (o *ServiceTriggerUpdateBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /v1/{namespace}/service/{server_id}/trigger/{id}/][%d] serviceTriggerUpdateBadRequest  %+v", 400, o.Payload)
}
...
func (o *ServiceTriggerUpdateNotFound) Error() string {
	return fmt.Sprintf("[PATCH /v1/{namespace}/service/{server_id}/trigger/{id}/][%d] serviceTriggerUpdateNotFound  %+v", 404, o.Payload)
}
