...
func (o *ServiceTriggerDeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /v1/{namespace}/service/{server_id}/trigger/{id}/][%d] serviceTriggerDeleteNoContent ", 204)
}
...
func (o *ServiceTriggerDeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /v1/{namespace}/service/{server_id}/trigger/{id}/][%d] serviceTriggerDeleteNotFound  %+v", 404, o.Payload)
}
