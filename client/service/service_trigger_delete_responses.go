...
func (o *ServiceTriggerDeleteNoContent) Error() string {
	return fmt.Sprintf("[DELETE /{namespace}/service/{server_pk}/trigger/{id}/][%d] serviceTriggerDeleteNoContent ", 204)
}
...
func (o *ServiceTriggerDeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /{namespace}/service/{server_pk}/trigger/{id}/][%d] serviceTriggerDeleteNotFound  %+v", 404, o.Payload)
}
