...
func (o *ServiceTriggerReadOK) Error() string {
	return fmt.Sprintf("[GET /{namespace}/service/{server_pk}/trigger/{id}/][%d] serviceTriggerReadOK  %+v", 200, o.Payload)
}
...
func (o *ServiceTriggerReadNotFound) Error() string {
	return fmt.Sprintf("[GET /{namespace}/service/{server_pk}/trigger/{id}/][%d] serviceTriggerReadNotFound  %+v", 404, o.Payload)
}
