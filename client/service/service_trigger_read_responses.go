...
func (o *ServiceTriggerReadOK) Error() string {
	return fmt.Sprintf("[GET /v1/{namespace}/service/{server_id}/trigger/{id}/][%d] serviceTriggerReadOK  %+v", 200, o.Payload)
}
...
func (o *ServiceTriggerReadNotFound) Error() string {
	return fmt.Sprintf("[GET /v1/{namespace}/service/{server_id}/trigger/{id}/][%d] serviceTriggerReadNotFound  %+v", 404, o.Payload)
}
