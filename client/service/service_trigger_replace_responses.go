...
func (o *ServiceTriggerReplaceOK) Error() string {
	return fmt.Sprintf("[PUT /v1/{namespace}/service/{server_id}/trigger/{id}/][%d] serviceTriggerReplaceOK  %+v", 200, o.Payload)
}
...
func (o *ServiceTriggerReplaceBadRequest) Error() string {
	return fmt.Sprintf("[PUT /v1/{namespace}/service/{server_id}/trigger/{id}/][%d] serviceTriggerReplaceBadRequest  %+v", 400, o.Payload)
}
...
func (o *ServiceTriggerReplaceNotFound) Error() string {
	return fmt.Sprintf("[PUT /v1/{namespace}/service/{server_id}/trigger/{id}/][%d] serviceTriggerReplaceNotFound  %+v", 404, o.Payload)
}
