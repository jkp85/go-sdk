...
func (o *ServiceTriggerUpdateParams) WithData(data *models.ServerActionData) *ServiceTriggerUpdateParams {
	o.SetData(data)
	return o
}

// SetData adds the data to the service trigger update params
func (o *ServiceTriggerUpdateParams) SetData(data *models.ServerActionData) {
	o.Data = data
}
