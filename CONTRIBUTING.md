...
1. Fork `https://github.com/3blades/go-sdk` repository to your user organization.
1. Clone your copy of `https://github.com/your-username/go-sdk` onto your machine using
